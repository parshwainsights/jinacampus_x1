...
2. `PRD.md`
3. `TASKS.md`
4. `docs/mobile-qa-checklist.md`, if present
5. Existing project files, if present
...
## 2.1 Current Strategic Priority
Before starting the next product MVP module such as FeeDesk, GradeBook, or SchoolCast, Codex must complete `TASKS.md` Phase 9: Base Application Polish & Usability Hardening.

Current priority is base UX hardening: smoother forms, practical edit flows, clearer empty/loading/error states, better tables and filters, role-aware navigation, dashboard polish, authenticated mobile QA, and demo seed readiness.

During Phase 9:

- Do not add new business modules.
- Do not start FeeDesk, GradeBook, or SchoolCast.
- Keep changes focused, small, and reviewable.
- Preserve tenant isolation, RBAC, audit logging, and QR token safety.
- Maintain mobile-first responsive quality.
- Use existing conventions and avoid unnecessary dependencies.

See `PRD.md`, `TASKS.md`, and `docs/mobile-qa-checklist.md` for the detailed Phase 9 plan.
