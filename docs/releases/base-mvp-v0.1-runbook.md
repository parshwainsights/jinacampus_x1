...
- The 2026-06-02 Administrator Portal QA covered the former tenant-role model and is superseded for platform authentication/deletion by the 2026-08-02 separation repair. Before release promotion, rerun DB-backed QA for the independent platform identity/session, forced platform password change, school CRUD, exact `Delete School` full teardown, retained platform audit, and school-user portal denial.
